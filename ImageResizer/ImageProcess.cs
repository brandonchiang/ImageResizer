...
namespace ImageResizer
{
    public class ImageProcess
    {
        ...
        public async Task ResizeImagesAsync(string sourcePath, string destPath, double scale)
        {
            ...
            foreach (var filePath in allFiles)
            {
                tasks[i] = Task.Run(() =>
                {
                    ...
                    ResizeOneImageAsync(destPath, scale, filePath);
                });
                i++;
            }
        ...
        private async Task ResizeOneImageAsync(string destPath, double scale, string filePath)
        {
            await Task.Run(() =>
            {
                ...
                processBitmap((Bitmap)imgPhoto,
                   ...
                   destionatonWidth, destionatonHeight, destFile);
            });
        }
        ...
        /// <returns></returns>
        void processBitmap(Bitmap img, int srcWidth, int srcHeight, int newWidth, int newHeight, string destFile)
        {
            ...
            resizedbitmap.Save(destFile, ImageFormat.Jpeg);
        }
    }
}
